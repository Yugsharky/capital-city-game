...
def find_capital_game():
    print("Welcome to the Guess the Capital Game!")
    print("You will be given a country, and you need to guess its capital.")
...
while True:
    ...
    country = random.choice(list(capitals.keys()))  # Fixed: Use capitals.keys() instead of capitals()
    correct_capital = capitals[country]

    # Ask the user to guess the capital
    user_guess = input(f"What is the capital of {country}? ").strip()
